                        ...
                        <form action="{{ route('postBillandDetail') }}" method="POST" class="needs-validation" novalidate>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="hoten" id="firstName" placeholder=""
                                        value="" required>
                                    <div class="invalid-feedback"> Valid first name is required. </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="lastName">SDT: </label>
                                    <input type="text" class="form-control" name="sdt" id="lastName" placeholder=""
                                        value="" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" hidden name="id_user"
                                    value="{{ session()->get('infoUser')['id'] }}" required>
                            </div>
                            <hr class="mb-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="same-address">
                                <label class="custom-control-label" for="same-address">Địa chỉ giao hàng giống với địa chỉ
                                    thanh toán của tôi</label>
                            </div>
                            <hr class="mb-4">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                                    ...
                                    @foreach ($dssanpham->products as $product)
                                        <div class="media mb-2 border-bottom">
                                            <div class="media-body"> <a
                                                    href="detail.html">{{ $product['productInfo']->TenSP }}</a>
                                                <div class="small text-muted">{{ $product['productInfo']->GiaMoi }} VND<span
                                                        class="mx-2">|</span> SL: {{ $product['quantity'] }}<span
                                                        class="mx-2">|</span> Tổng tiền: {{ $product['price'] }} VND
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <div class="col-12 d-flex shopping-box">
                            <button type="submit" class="ml-auto btn hvr-hover">Đặt hàng</a>
                        </div>
                        </form>
                    </div>
                </div>
